...
const Home = () => {
    ...
    function handleSelectUf(value: any) {
        setSelectUF(value);
        //Por segurança adicionei aque para resetar a cidade selecionado
        setSelectCity('0');
    }
    ...
    return (
        <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS == 'ios' ? 'padding' : undefined}>
            <ImageBackground
                ...
                imageStyle={{ width: 274, height: 375 }}>
                ...
                <View style={styles.footer}>
                    ...
                    <RNPickerSelect
                        ...
                        //mesmo utilizando nativo android sumiu o icone quando  usei style
                        useNativeAndroidPickerStyle
                        Icon={() => (
                            <Icon name="chevron-down" color="#000" size={24} />
                        )}
                    />
